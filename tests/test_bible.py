...
class TestBible:
                ...
                "chapters": [
                    ...
                    },
                    {
                        ...
                        "verses": [
                            ...
                            {"verse": "2", "text": "And on the seventh day God ended his work which he had made."}
                        ]
                    }
                ]
            }
    ...
    def test_get_text_cross_chapter(self, temp_data_folder):
        ...
        expected = ("And God said, Let there be light: and there was light. "
