...
class Prompts:
    ...
    def get_prompt_by_id(self, prompt_id: str) -> Dict[str, str]:
        ...
        raise ValueError(f"Prompt ID '{prompt_id}' not found. Available IDs: {', '.join(available_ids[:10])}...")
    ...
    def _fold_lines(self, text: str, width: int = 100) -> str:
        ...
        for line in lines:
            if len(line) <= width:
                ...
                wrapped_lines = textwrap.fill(line, width=width, break_long_words=False, break_on_hyphens=False)
