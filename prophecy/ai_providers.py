...
class ChatGPTProvider(AIProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, 
        ...
        if not self.api_key:
            raise AIProviderError("OpenAI API key not provided and OPENAI_API_KEY environment variable not set")
...
class ClaudeProvider(AIProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, 
        ...
        if not self.api_key:
            raise AIProviderError("Anthropic API key not provided and ANTHROPIC_API_KEY environment variable not set")
...
class AIProviderFactory:
    ...
    def create_provider(cls, provider_name: str, **kwargs) -> AIProvider:
        ...
        if provider_name not in cls._providers:
            ...
            raise ValueError(f"Unsupported AI provider: {provider_name}. Available providers: {available}")
